...
CLM.L["Add to roster"] = "Zu Roster hinzufügen"
-- Modules/RosterManager/GUI.lua:498
CLM.L["Add to standby"] = "Zum Standby hinzufügen"
-- Modules/LedgerManager/GUI.lua:309
CLM.L["Add"] = "Hinzufügen"
-- Migration.lua:349
CLM.L["Adding %s loot entries for team to %s"] = "Fügt %s Looteinträge zum Team für %s hinzu"
-- Migration.lua:208
-- Migration.lua:327
CLM.L["Adding %s profiles to %s"] = "Fügt %s Profile zu %s hinzu"
...
CLM.L["Additional cost (tax) to add to the award value."] = "Zusätzliche Kosten (Steuer) die zum Gewinngebot hinzugefügt werden."
-- Modules/RosterManager/Options.lua:755
CLM.L["Additional points to be given to players atop of the split value."] = "Zusätzliche Punkte an Spieler die zur Split Value vergeben werden."
-- Modules/ProfileManager/GUI.lua:289
CLM.L["Adds selected players or everyone if none selected to the selected roster (from dropdown)."] = "Fügt ausgewählen SSpieler, oder alle wenn keiner ausgewählt ist, zum ausgewählten Roster (Dropdown)."
...
CLM.L["All in"] = "All in"
-- Migration.lua:28
CLM.L["All migration entries were commited and executed. Congratulations!"] = "Alle Migrierungseinträge wurden ausgeführt. Glückwunsch!"
-- Modules/RosterManager/GUI.lua:177
-- Modules/ProfileManager/GUI.lua:110
CLM.L["All"] = "Alle"
-- Modules/RosterManager/Options.lua:769
CLM.L["Allow Negative Bidders"] = "Erlaube negative Gebote"
-- Modules/RosterManager/Options.lua:762
CLM.L["Allow Negative Standings"] = "Erlaube negative Punkte"
-- Modules/LedgerManager/GUI.lua:116
CLM.L["Allow bidding below 0 DKP"] = "Erlaube Gebote unter 0 DKP"
