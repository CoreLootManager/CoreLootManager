...
CLM.L["Base value for Static-Priced auction.\nMinimum value for Ascending and Tiered auction.\n\nSet to same value as other tier or negative to ignore."] = "Valor base para una subasta de precio estático. \ Valor mínimo para subasta ascendente y escalonada. \ En \ establecer al mismo valor que otro nivel o negativo para ignorar."
...
CLM.L["Bid tiers: %s."] = "Niveles de ofertas: %s."
...
CLM.L["Classic Loot Manger"] = "Gerente de botín clásico"
...
CLM.L["Large value for Tiered auction.\n\nSet to same value as other tier or negative to ignore."] = "Gran valor para la subasta escalonada. \ In \ establecer al mismo valor que otro nivel o negativo para ignorar."
...
CLM.L["Maximum value for Ascending and Tiered auction.\n\nSet to same value as other tier or negative to ignore."] = "Valor máximo para subasta ascendente y escalonada. \ In \ establecer al mismo valor que otro nivel o negativo para ignorar."
...
CLM.L["Select modifier combination for auctioning from bags and corpse."] = "Seleccione la combinación de modificadores para subastarse de bolsas y cadáveres."
...
CLM.L["Small value for Tiered auction.\n\nSet to same value as other tier or negative to ignore."] = "Pequeño valor para subasta escalonada. \ In \ establecer al mismo valor que otro nivel o negativo para ignorar."
...
CLM.L["|cff00ee44Open:|r English Auction with highest bidder announcement. Highest bidder wins. Two players can not bid same value. Additionally always allows bidding base to accomodate for Swedish Auction flavor.\n\n|cff00ee44Anonymous Open:|r Same as Open but highest bidder name is not disclosed.\n\n|cff00ee44Sealed:|r Bids are not announced. Highest bidder wins.\n\n|cff00ee44Vickrey:|r Same as sealed but winner pays with second-highest bid."] = "| CFF00EE44Pen: | R Subasta en inglés con el mejor anuncio de postor. El mejor postor gana. Dos jugadores no pueden ofertar el mismo valor. Además, siempre permite que la base de licitación se acomode para el sabor de subasta sueca. \ N \ n | CFF00EE44 ABIERTO ABIERTO: | R Igual que no se revele el nombre de postor abierto pero más alto. El mejor postor gana. \ N \ n | cff00ee44vickrey: | r igual que el sellado pero el ganador paga con la segunda oferta más alta."
-- Modules/RosterManager/Options.lua:732
-- Modules/RosterManager/Options.lua:834
CLM.L["|cff00ee44Single-Priced:|r Static value mode. Only bidding Base value is supported.\n\n|cff00ee44Ascending:|r Ranged value mode. Allows bidding any value in |cff44ee00<base, max>|r.\n\n|cff00ee44Tiered:|r Ranged value mode. Allows bidding only specific values. Up to 5 tiers are configurable in |cff44ee00<base, small, medium, large, max>|r."] = "| CFF00EE44-precio: | R Modo de valor estático. Solo se admite el valor base de oferta. Permite ofertar cualquier valor en | cff44ee00 <base, max> | r. \ N \ n | cff00ee44tiered: | r ranged valor modo. Permite ofertar solo valores específicos. Hasta 5 niveles son configurables en | cff44ee00 <base, pequeña, mediana, grande, max> | r."
