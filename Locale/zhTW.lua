...
CLM.L["Exponent / Base"] = "指數 /基礎"
-- Modules/Rosters/RosterManager/Options.lua:450
CLM.L["Exponential scaling value used by the equations (Base for EPGPWeb, or Exponent for WoWpedia)"] = "方程式使用的指數縮放值（EPGPWEB的基礎或WoWpedia指數）"
-- MinimapIcon.lua:132
...
CLM.L["Select loot rarity for the tracking unauctioned loot."] = "为记录未拍卖的战利品选择战利品稀有度。"
...
CLM.L["Toggles alerts display when receiving Points or loot."] = "开关警报提示在获得分数或战利品时。"
...
CLM.L["Toggles posting bids in selected channel after auction has ended."] = "开关在拍卖结束后在选定频道中通告出价。"
...
CLM.L["Tracked loot rarity"] = "追踪战利品稀有度"
