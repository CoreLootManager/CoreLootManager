...
CLM.L["Decay %s%% points to everyone in roster."] = "Размещение%s %% указывает на всех в списке."
...
CLM.L["Lock selected"] = "Заблокирована выбрано"
...
CLM.L["Unlock selected"] = "Разблокировать выбранный"
-- Migration.lua:124
