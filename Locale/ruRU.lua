...
CLM.L["New highest bidder: %s (%d DKP)"] = "Новая наибольшая ставка: %s (%d ДКП)"
...
CLM.L["Type of auction used: Open, Sealed, Vickrey (Sealed with second-highest pay price)."] = "Используемый тип аукциона: Открытый, Закрытый, Аукцион Викри (закрытый со второй высшей ценой вещи)."
CLM.L["Type"] = "Тип"
