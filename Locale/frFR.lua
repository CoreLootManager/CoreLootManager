...
CLM.L["!dkp"] = "!dkp"
-- Modules/GUI/UnifiedGUI_Standings.lua:248
CLM.L["% that will be decayed."] = "% qui sera décomposé"
...
CLM.L["Action to take upon Gargul loot award event happening during raid."] = "Action pour assumer l'événement Gargul Loot Award se déroule pendant le raid."
...
-- Modules/GUI/UnifiedGUI_Standings.lua:518
...
CLM.L["Allow biding more than current standings and ending up with less than minimum points."] = "Permettre de miser plus que le total de points et terminer avec moins que le montant minimum"
-- Modules/RosterManager/Options.lua:864
CLM.L["Allow biding more than current standings"] = "Permettre de miser plus que le total de points"
...
-- Modules/RosterManager/Roster.lua:606
...
-- Modules/GUI/UnifiedGUI_Standings.lua:340
-- Modules/GUI/UnifiedGUI_Standings.lua:353
CLM.L["Att. [%]"] = "Prés. [%]"
...
CLM.L["Award for Free"] = "Prix gratuitement"
-- Integrations/Integrations.lua:363
CLM.L["Award for Large"] = "Prix pour grand"
-- Integrations/Integrations.lua:364
CLM.L["Award for Max"] = "Prix pour Max"
-- Integrations/Integrations.lua:362
CLM.L["Award for Medium"] = "Prix pour le médium"
-- Integrations/Integrations.lua:361
CLM.L["Award for Small"] = "Prix pour petit"
...
CLM.L["Award points to players based on context."] = "Le récompense pointe des joueurs en fonction du contexte."
...
-- Modules/GUI/UnifiedGUI_Standings.lua:336
-- Modules/GUI/UnifiedGUI_Standings.lua:349
...
-- Modules/GUI/UnifiedGUI_Standings.lua:406
-- Modules/GUI/UnifiedGUI_Standings.lua:425
CLM.L["DKP"] = "DKP"
...
CLM.L["Druid"] = "Druide"
-- Alerts/Alerts.lua:17
-- Modules/GUI/UnifiedGUI_Standings.lua:389
-- Modules/GUI/UnifiedGUI_Standings.lua:390
-- Modules/GUI/UnifiedGUI_Standings.lua:425
CLM.L["EP"] = "EP"
-- Alerts/Alerts.lua:20
...
CLM.L["Enable Gargul integration. This will allow Gargul to take control over some aspects of CLM (starting auction from Gargul, and awarding)."] = "Activer l'intégration de Gargul. Cela permettra à Gargul de prendre le contrôle de certains aspects du CLM (commençant les enchères de Gargul et attribuant)."
...
-- MinimapIcon.lua:78
CLM.L["Enables / disables minimap Icon"] = "Active/désactive l'icône autour de la minimap"
...
CLM.L["Europe"] = "Europe"
-- Modules/GUI/UnifiedGUI_Standings.lua:272
CLM.L["Execute decay for players based on context."] = "Appliquer la décomposition aux joueurs en fonction du contexte"
-- Migration.lua:368
...
CLM.L["Gargul Integration"] = "Gargul Intégration"
...
CLM.L["Healer"] = "Guérisseuse Guérisseur"
...
-- Modules/GUI/UnifiedGUI_Standings.lua:258
CLM.L["Include players with negative standings in decay."] = "Inclure les joueurs avec un montant négatif à la décomposition"
-- MinimapIcon.lua:46
CLM.L["Incoherent state"] = "État incohérent"
-- Modules/GUI/UnifiedGUI_History.lua:144
CLM.L["Info"] = "Info"
-- Modules/GUI/UnifiedGUI_Standings.lua:388
-- Modules/GUI/UnifiedGUI_Standings.lua:392
...
-- Modules/ConfigManager/ConfigManager.lua:131
-- Modules/ConfigManager/ConfigManager.lua:136
-- Modules/ConfigManager/ConfigManager.lua:141
...
-- Modules/GUI/UnifiedGUI_Standings.lua:303
CLM.L["Invalid context. You should not decay raid only."] = "Contexte non valide. Vous ne devez pas se décomposer uniquement."
...
CLM.L["Large value for Tiered auction.\n\nSet to same value as other tier or negative to ignore."] = "Grande valeur pour les enchères par niveau. \n\nRemplissez la même valeur que les autres niveaux ou une valeur négative pour ignorer"
...
CLM.L["Maximum value for Ascending and Tiered auction.\n\nSet to same value as other tier or negative to ignore."] = "Valeur maximum pour les enchères montantes.\n\nRemplissez la même valeur que les autres niveaux ou une valeur négative pour ignorer"
-- Integrations/GUI.lua:143
CLM.L["May"] = "Mai"
-- Modules/RosterManager/Options.lua:310
CLM.L["Medium value for Tiered auction.\n\nSet to same value as other tier or negative to ignore."] = "Moyenne valeur pour les enchères par niveau. \n\nRemplissez la même valeur que les autres niveaux ou une valeur négative pour ignorer"
...
CLM.L["Minimum GP used in calculations when player has less GP than this value."] = "GP minimum utilisé dans les calculs lorsque le joueur a moins de GP que cette valeur."
...
CLM.L["Minimum points to be allowed to bid."] = "Montant minimum pour être autorisé à miser"
-- Modules/RosterManager/Options.lua:745
CLM.L["Minimum points"] = "Montant minimum"
-- Modules/GUI/UnifiedGUI_Standings.lua:228
CLM.L["Missing award value"] = "Valeur de récompense manquante"
-- Modules/GUI/UnifiedGUI_Standings.lua:301
CLM.L["Missing decay value"] = "Valeur de désintégration manquante"
...
-- Modules/GUI/UnifiedGUI_Standings.lua:333
-- Modules/GUI/UnifiedGUI_Standings.lua:346
...
-- Modules/GUI/UnifiedGUI_Standings.lua:290
CLM.L["No players selected"] = "Aucun joueur sélectionné."
-- Modules/GUI/UnifiedGUI_Standings.lua:436
...
-- Modules/GUI/UnifiedGUI_Standings.lua:521
-- Modules/GUI/UnifiedGUI_Standings.lua:565
...
CLM.L["Open Key Bindings UI for AddOns"] = "Open clés de liaisons UI pour les addons"
...
CLM.L["PASS"] = "PASSE"
-- Modules/GUI/UnifiedGUI_Standings.lua:348
CLM.L["PR"] = "PR"
-- .:indirectly
...
-- Modules/GUI/UnifiedGUI_Standings.lua:335
CLM.L["Points"] = "Points"
-- Utils.lua:730
CLM.L["Poor"] = "Médiocre"
...
CLM.L["Profile %s already exists and is used by different GUID %s (%s). "] = "Le profil %s existe déjà et est utilisé par différents de Guid %s (%s)."
...
-- Modules/GUI/UnifiedGUI_Standings.lua:692
CLM.L["Raid"] = "Raid"
...
-- Integrations/Integrations.lua:133
-- Integrations/Integrations.lua:143
CLM.L["Regular"] = "Habituelle Habituel"
...
-- Modules/GUI/UnifiedGUI_Standings.lua:610
CLM.L["Remove from roster"] = "Retirer de la liste"
-- Modules/GUI/UnifiedGUI_Standings.lua:562
...
-- Modules/GUI/UnifiedGUI_Standings.lua:691
-- Modules/GUI/UnifiedGUI_Raids.lua:308
-- Modules/GUI/UnifiedGUI_History.lua:93
CLM.L["Roster"] = "Liste"
-- Modules/ConfigManager/ConfigManager.lua:130
-- Modules/ConfigManager/ConfigManager.lua:135
-- Modules/ConfigManager/ConfigManager.lua:140
...
-- Modules/RosterManager/Roster.lua:585
CLM.L["SK"] = "SK"
...
-- Modules/RosterManager/Roster.lua:611
CLM.L["Sealed"] = "Scellé"
...
-- Modules/GUI/UnifiedGUI_Standings.lua:690
...
-- Modules/GUI/UnifiedGUI_Standings.lua:339
-- Modules/GUI/UnifiedGUI_Standings.lua:352
...
CLM.L["The Obsidian Sanctum"] = "Sanctum Obsidien"
...
-- MinimapIcon.lua:77
CLM.L["Toggle Minimap Icon"] = "Afficher l'icone de minimap"
...
-- Modules/GUI/UnifiedGUI.lua:413
CLM.L["Toggle standings window display"] = "Basculer l'affichage de la fenêtre des classements"
-- Global/GlobalConfigs.lua:83
CLM.L["Toggles addon sounds."] = "Active les sons de l'addon"
-- Global/GlobalConfigs.lua:50
CLM.L["Toggles alerts display when receiving Points or loot."] = "Bascule les alertes affichées lors de la réception de points ou de butin."
...
CLM.L["Two different profiles exist for target GUID %s (%s:%s) and name %s (%s:%s). Verify and clean up profiles before updating."] = "Deux profils différents existent pour le Guid %s cible (%s:%s) et le nom %s (%s:%s). Vérifiez et nettoyez les profils avant de mettre à jour."
...
CLM.L["Will display names of the buttons instead of values in bidding UI"] = "Affichera les noms des boutons au lieu des valeurs dans l'interface utilisateur d'enchères"
-- Global/GlobalConfigs.lua:91
CLM.L["Wipe events"] = "Effacer les événements"
-- Modules/Logger/Logger.lua:41
CLM.L["Wipe"] = "Effacer"
-- Global/GlobalConfigs.lua:92
...
-- Modules/GUI/UnifiedGUI_Standings.lua:582
-- Modules/GUI/UnifiedGUI_Standings.lua:591
...
-- Modules/GUI/UnifiedGUI_Standings.lua:547
...
-- Modules/GUI/UnifiedGUI_Standings.lua:529
...
-- Modules/GUI/UnifiedGUI_Standings.lua:573
...
-- Modules/GUI/UnifiedGUI_Standings.lua:624
...
CLM.L["[Roster Field Rename]: "] = "[Renommer le champ de la liste]:"
-- Modules/LedgerManager/GUI.lua:314
-- Modules/GUI/UnifiedGUI_Audit.lua:233
CLM.L["[Roster Item Value Override Single]: "] = "[Remplacer la valeur de l'item]"
...
-- Modules/GUI/UnifiedGUI_Standings.lua:539
-- Modules/GUI/UnifiedGUI_Standings.lua:548
CLM.L["add"] = "ajouter"
...
CLM.L["cancel"] = "annuler"
-- Modules/GUI/UnifiedGUI_Standings.lua:548
-- Modules/GUI/UnifiedGUI_Standings.lua:592
CLM.L["created"] = "créé"
-- Global/GlobalChatMessageHandlers.lua:58
CLM.L["denied"] = "refusé"
...
CLM.L["pass"] = "passe"
-- Modules/GUI/UnifiedGUI_Standings.lua:539
-- Modules/GUI/UnifiedGUI_Standings.lua:583
...
CLM.L["|cff00ee44Open:|r English Auction with highest bidder announcement. Highest bidder wins. Two players can not bid same value. Additionally always allows bidding base to accomodate for Swedish Auction flavor.\n\n|cff00ee44Anonymous Open:|r Same as Open but highest bidder name is not disclosed.\n\n|cff00ee44Sealed:|r Bids are not announced. Highest bidder wins.\n\n|cff00ee44Vickrey:|r Same as sealed but winner pays with second-highest bid."] = "Enchère avec annonce de la plus haute mise. Le joueur avec la plus grosse mise l"
-- Modules/RosterManager/Options.lua:732
-- Modules/RosterManager/Options.lua:834
CLM.L["|cff00ee44Single-Priced:|r Static value mode. Only bidding Base value is supported.\n\n|cff00ee44Ascending:|r Ranged value mode. Allows bidding any value in |cff44ee00<base, max>|r.\n\n|cff00ee44Tiered:|r Ranged value mode. Allows bidding only specific values. Up to 5 tiers are configurable in |cff44ee00<base, small, medium, large, max>|r."] = "|cff00ee44Prix fixe:|r Mode à valeur statique. Seule la Valeur de mise de base est supportée.n\n|cff00ee44Montante:|r Mode à valeur d’intervalle. Permet de miser n’importe quelle valeur entre |cff44ee00<base, max>|r.\n\n|cff00ee44Par niveau:|r Mode à valeur d’intervalle. Permet de miser uniquement des valeurs spécifiques. Jusqu’à 5 valeurs sont configurables dans |cff44ee00<base, petit, moyen, grand, max>|r."
