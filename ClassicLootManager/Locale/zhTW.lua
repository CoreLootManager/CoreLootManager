...
CLM.L["Ignore unusable items"] = "忽略無法使用的項目"
...
CLM.L["Ignores unusable items. They will not be added to bidding window."] = "忽略無法使用的項目。 它們不會添加到競標窗口中。"
...
CLM.L["Post all bids after awarding item"] = "授予所有投標"
-- ClassicLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:516
CLM.L["Post all bids on award"] = "發布所有出價"
...
CLM.L["Restore bar defaults"] = "還原條默認值"
...
CLM.L["You are changing roster settings during active raid. You can continue without any issues however the settings will not get applied until you start a new one."] = "您將在主動突襲過程中更改名冊設置。 您可以繼續沒有任何問題，但是在開始新的問題之前，這些設置將不會應用。"
