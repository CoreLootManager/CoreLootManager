...
CLM.L["%s not present in any roster."] = "%s 不在任何名册中。"
...
CLM.L["%s standings in %d %s:"] = "%s 积分榜 in %d %s:"
...
CLM.L["%s to be awarded to player when joining roster."] = "%s 將獎勵給加入名單時的玩家。"
-- ClassicLootManager/Modules/Auctioning/AutoAssign/GUI.lua:172
CLM.L["%s trade me for %s"] = "%s 交易我為 %s"
...
CLM.L["%s: %d DKP (%d this week)."] = "%s: %d DKP (%d 本周)."
...
CLM.L["Accepting rolls on %s for %s %s"] = "接受 %s 以 %s %s 接受擲骰"
...
CLM.L["Are you sure, you want to disenchant %s?"] = "您確定，您想貶低%s嗎？"
-- ClassicLootManager/Modules/Profiles/ProfileManager/AltMainLinkingGUI.lua:78
CLM.L["Are you sure, you want to link %s as alt of %s?"] = "您確定，您想將%s鏈接為 %s 嗎？"
...
CLM.L["Automatically mark auto-removed items as disenchanted"] = "自動將自動驅動的物品標記為污點"
...
CLM.L["Case-sensitive Player name in the format: Player-RealmName"] = "案例敏感的播放器名稱格式：player-realmname"
...
CLM.L["Comma-separated (CSV) list of disenchanter names. Case insensitive."] = "逗號分隔（CSV）刪除名稱列表。 不區分大小寫。"
...
CLM.L["Enable to always allow 0 bids. Affects Open-Ascending Auction."] = "启用始终允许0出价。影响开放式拍卖(Open-Ascending)。"
...
CLM.L["Execute migration again if you are sure this is correct."] = "如果您確定這是正確的，請再次執行遷移。"
...
CLM.L["Executing migration even though ledger is not empty."] = "執行遷移，即使Ledger不是空的。"
...
CLM.L["Include cancels in bid list in open auction mode."] = "在開放拍賣模式下將CAMCELS包括在投標列表中。"
...
CLM.L["Include passes in bid list in open auction mode."] = "在開放拍賣模式下包括通過投標列表中的通行證。"
...
CLM.L["Missing profile for player %s."] = "角色信息缺失 %s."
...
CLM.L["Moving %s from current queue to pending queue."] = "將 %s 從當前隊列移動到等待隊列。"
...
CLM.L["Removing %s from current queue."] = "從當前隊列中刪除 %s。"
...
CLM.L["Select default behavior whenever group loot rolling window gets opened. This will be active only during CLM Raid and while in Raid instance."] = "每當打開“組戰利擲骰”窗口時，請選擇默認行為。 這僅在CLM RAID期間和在突襲實例中處於活動狀態。"
...
CLM.L["Select |cffeeee00%s|r encounter difficulty for bonus value award (%s)."] = "選擇|cffeee00%s |r的獎金價值獎（%s）遇到困難。"
...
CLM.L["Toggle Trade List window display"] = "切換貿易列表窗口顯示"
...
CLM.L["Toggle default behavior of remove on award field in auctioning ui"] = "在拍賣UI中，在獎勵字段中刪除刪除的默認行為"
...
CLM.L["Toggles auto-rolling on legendary items."] = "在傳奇項目上切換自動擲骰。"
-- ClassicLootManager/Modules/Global/GlobalConfigs.lua:327
CLM.L["Toggles auto-rolling on patterns."] = "在配方上切換自動擲骰。"
-- ClassicLootManager/Modules/Global/GlobalConfigs.lua:319
CLM.L["Toggles auto-rolling on stacking items."] = "在可堆疊項目上切換自動擲骰。"
...
CLM.L["Will hide bidding window if you enter combat and show it again when you exit. Will also delay auto opening if needed."] = "如果您輸入戰鬥並在退出時再次顯示出來，將隱藏出價窗口。 如果需要，還將延遲自動打開。"
...
CLM.L["Your bid (%s) was %s%s."] = "您的竞拍 (%s) 是 %s%s."
