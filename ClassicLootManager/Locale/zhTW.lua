...
CLM.L["Are you sure, you want to bid on an unusable item %s?"] = "您確定，您想競標不可用的項目 %s 嗎？"
...
CLM.L["Toggles auto-rolling on cosmetics."] = "在化妝品上切換自動滾動。"
...
CLM.L["Toggles auto-rolling on mounts."] = "在安裝座上切換自動滾動。"
...
CLM.L["Toggles auto-rolling on toys."] = "切換自動滾動玩具。"
