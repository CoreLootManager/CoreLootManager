...
CLM.L["Execute migration"] = "Выполнить миграцию"
...
CLM.L["Toggles auto-rolling on mounts."] = "Включить авто-ролл на креплениях."
...
CLM.L["Toggles auto-rolling on toys."] = "Включить авто-ролл на игрушках."
