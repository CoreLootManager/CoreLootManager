...
CLM.L["Automatically mark auto-removed items as disenchanted"] = "Автоматически отмечать автоматические элементы как разочарованные"
...
CLM.L["Disenchant removed items"] = "Разочаровано удаленные предметы"
