...
CLM.L["Are you sure, you want to bid on an unusable item %s?"] = "Êtes-vous sûr, vous souhaitez enchérir sur un article inutilisable %s?"
...
CLM.L["Execute migration"] = "Exécuter la migration"
