...
CLM.L["%s not present in any roster."] = "%s n'est présent dans aucun roster."
...
CLM.L["%s standings in %d %s:"] = "%s Classé dans %d %s:"
...
CLM.L["%s: %d DKP (%d this week)."] = "%s: %d DKP (%d cette semaine)."
...
CLM.L["Always allow 0 bids"] = "Toujours autoriser les offres 0"
...
CLM.L["Always show"] = "Toujours afficher"
...
CLM.L["Are you sure, you want to link %s as alt of %s?"] = "Êtes-vous sûr, vous souhaitez lier %s comme alt de %s?"
-- ClassicLootManager/Modules/Profiles/ProfileManager/AltMainLinkingGUI.lua:95
CLM.L["Are you sure, you want to unlink %s from its main?"] = "Êtes-vous sûr, vous voulez dissocier %s de sa principale?"
...
CLM.L["Auction column"] = "Colonne d'enchère"
...
CLM.L["Award %s %s to %s selected players."] = "Attribuer %s %s aux %s joueurs sélectionnés."
-- ClassicLootManager/Modules/GUI/UnifiedGUI_Standings.lua:242
CLM.L["Award %s %s to everyone in raid."] = "Attribuer %s %s à tous les membres du raid."
-- ClassicLootManager/Modules/GUI/UnifiedGUI_Standings.lua:244
CLM.L["Award %s %s to everyone in roster."] = "Attribuer %s %s à tout le roster."
...
CLM.L["Case-sensitive Player name in the format: Player-RealmName"] = "Nom du joueur sensible à la casse dans le format: Joueur-REALMNAME"
...
CLM.L["Core Loot Manager %s initialization complete. %s"] = "Core Loot Manager %s initialisation terminée. %s"
...
CLM.L["Cross-guild sync"] = "Synchronisation du guild"
...
CLM.L["Enable item tracking information in tooltip display."] = "Activer le suivi d'objets dans le tooltip"
...
CLM.L["Enable tooltip display"] = "Activer l'affichage du tooltip"
...
CLM.L["Execute migration again if you are sure this is correct."] = "Exécutez à nouveau la migration si vous êtes sûr que c'est correct."
...
CLM.L["Executing migration even though ledger is not empty."] = "Exécuter la migration même si le grand livre n'est pas vide."
...
CLM.L["Extend auction bid list with received item count information. Requires reload."] = "Etendre la liste d'enchères avec les informations de comptage d'objets reçues. Requiert un rechargement"
-- ClassicLootManager_Tracker/ClassicLootManager_Tracker.lua:65
CLM.L["Extend tooltip with more specific loot information."] = "Etendre le tooltip avec plus d'informations spécifiques au butin"
-- ClassicLootManager_Tracker/ClassicLootManager_Tracker.lua:64
CLM.L["Extended tooltip"] = "Tooltip étendu"
...
CLM.L["Include cancels in bid list in open auction mode."] = "Incluez les annulations dans la liste des offres en mode d'enchères ouvertes."
...
CLM.L["Include cancels"] = "Inclure les annulations"
...
CLM.L["Include passes in bid list in open auction mode."] = "Inclure des passes dans la liste des offres en mode d'enchères ouvertes."
...
CLM.L["Include passes"] = "Inclure des passes"
...
CLM.L["Loot Rolling"] = "Rand sur butin"
...
CLM.L["Missing profile for player %s."] = "Profil manquant pour le joueur %s."
...
CLM.L["Multiply auction time by the number of items to increase auction time lineary."] = "Multiplier le temps d'enchères par le nombre d'articles peut augmenter linéairement le temps d'enchères."
-- ClassicLootManager/Modules/Rosters/RosterManager/Options.lua:1154
CLM.L["Multiply time"] = "Temps de multiplication"
...
CLM.L["Roll on Loot"] = "Lancer un rand sur butin"
...
CLM.L["Select default behavior whenever group loot rolling window gets opened. This will be active only during CLM Raid and while in Raid instance."] = "Sélectionner un comportement par défaut à chaque fois qu'une fenêtre de rand sur butin est ouverte. Ceci ne sera actif qu'en cours de raid CLM ou dans une instance de raid"
...
CLM.L["Show tooltip info even outside of CLM raid."] = "Montrer le tooltip d'information d'évènement en dehors du raid CLM"
...
CLM.L["Your bid (%s) was %s%s."] = "Ton enchère (%s) est %s%s."
