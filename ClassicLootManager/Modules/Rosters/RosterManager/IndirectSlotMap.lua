...
local IndirectMap = {
    slot = {
        ...
        --[235045] = "INVTYPE_2HWEAPON",  -- Imperial Qiraji Regalia --- Multiple different item types available from item, unsure what to set as
        --[235046] = "INVTYPE_2HWEAPON",  -- Imperial Qiraji Armaments --- Multiple different item types available from item, unsure what to set as
    ...
    ilvl = {
        ...
        --[235045] = 79,  -- Imperial Qiraji Regalia --- See slot section note
        --[235046] = 79,  -- Imperial Qiraji Armaments --- See slot section note
