...
function Modify:type()
    return self.n and ILM.CONSTANTS.POINT_CHANGE_TYPE.SPENT or ILM.CONSTANTS.POINT_CHANGE_TYPE.POINTS
end
...
function Decay:new(rosterUid, playerList, value, reason, note, pointType)
    ...
    note = note or ""
    o.t = tostring(note)
    o.i = tonumber(pointType) or ILM.CONSTANTS.POINT_CHANGE_TYPE.TOTAL
    return o
end
...
function Decay:type()
    return self.i or ILM.CONSTANTS.POINT_CHANGE_TYPE.TOTAL
end
