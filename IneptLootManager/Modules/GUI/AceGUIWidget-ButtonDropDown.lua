...
do
	local widgetType = "ILMButtonDropDown"
...
---@diagnostic disable-next-line: redundant-parameter
	...
	local function Constructor()
		...
		local frame = CreateFrame("Button", "ILMAceGUI30ButtonDropDown"..count, UIParent, "UIPanelButtonTemplate")--"UIDropDownMenuTemplate")
...
hooksecurefunc(S, "Ace3_RegisterAsWidget", function(_, widget)
    if widget.type == "ILMButtonDropDown" then
