...
local EXPORT_DATA_TYPE_GUI = {
    -- [PRIV.CONSTANTS.EXPORT_DATA_TYPE.CONFIGS] = CLM.L["Configuration"],
    [PRIV.CONSTANTS.EXPORT_DATA_TYPE.STANDINGS] = CLM.L["Standings"],
    [PRIV.CONSTANTS.EXPORT_DATA_TYPE.POINT_HISTORY] = CLM.L["Point History"],
    [PRIV.CONSTANTS.EXPORT_DATA_TYPE.LOOT_HISTORY] = CLM.L["Loot History"],
    -- [PRIV.CONSTANTS.EXPORT_DATA_TYPE.RAIDS] = CLM.L["Raids"],
